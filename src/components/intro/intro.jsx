...
//               I am a passionate coder , Full stack and React developer , an avid
//               learner with great passion for technology and love to explore new
//               domains and build innovative solutions.
//             </span>
//             <span className="description">
//               Email me on : baluchander2205@gmail.com
//             </span>
//           </div>
//         </div>
//         <div className="right">
      ...
      <div className="intro" id="intro">
        ...
        <div className="right">
          <div className="wrapper">
            ...
            <div className="buttons">
              <a href="assets/BaluResume.pdf" download="balu resume.pdf">
                <button className="but">Get Resume</button>
              </a>
            </div>
            <span className="swp">Swipe to see more</span>
